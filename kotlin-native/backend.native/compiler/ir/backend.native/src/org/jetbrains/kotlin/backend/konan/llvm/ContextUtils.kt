...
internal class CodegenLlvmHelpers(private val generationState: NativeGenerationState, module: LLVMModuleRef) : BasicLlvmHelpers(generationState, module), RuntimeAware {
    ...
    val rtgc_updateObjectRefFunction = importRtFunction("rtgc_UpdateHeapRef", false)
    val rtgc_updateVolatileObjectRefFunction = importRtFunction("rtgc_UpdateVolatileHeapRef", false)
