...
class FinalImplA: <!OPT_IN_TO_INHERITANCE_ERROR("ApiMarker; This class or interface requires opt-in to be implemented. Its usage must be marked with '@ApiMarker' or '@OptIn(ApiMarker::class)'")!>OpenKlass<!>()
