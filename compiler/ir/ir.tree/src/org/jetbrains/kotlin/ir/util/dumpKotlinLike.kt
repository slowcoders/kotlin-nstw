...
//        }
    ...
    override fun visitBoundFunctionReference(expression: IrBoundFunctionReference, data: IrDeclaration?) = wrap(expression, data) {
    ...
    override fun visitBoundPropertyReference(expression: IrBoundPropertyReference, data: IrDeclaration?) = wrap(expression, data) {
        p.printWithNoIndent(expression.type.dumpKotlinLike())
        p.printlnWithNoIndent("(")
        p.pushIndent()
        p.print("/* bound = */ [")
