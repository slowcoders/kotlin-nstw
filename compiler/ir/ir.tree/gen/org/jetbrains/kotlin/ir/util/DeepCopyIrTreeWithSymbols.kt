...
open class DeepCopyIrTreeWithSymbols(
    ...
    override fun visitClass(declaration: IrClass): IrClass =
        IrClassImpl(
            ...
            declarations.addAll(declaration.declarations.memoryOptimizedMap { it.transform() })
    ...
    override fun visitModuleFragment(declaration: IrModuleFragment): IrModuleFragment =
        IrModuleFragmentImpl(
            ...
            files.addAll(declaration.files.memoryOptimizedMap { it.transform() })
    ...
    override fun visitScript(declaration: IrScript): IrScript =
        IrScriptImpl(
            ...
            with(factory) { declarationCreated() }
            statements.addAll(declaration.statements.memoryOptimizedMap { it.transform() })
            thisReceiver = declaration.thisReceiver?.transform()
    ...
    override fun visitBlock(expression: IrBlock): IrBlock =
        IrBlockImpl(
            ...
            statements.addAll(expression.statements.memoryOptimizedMap { it.transform() })
            processAttributes(expression)
        }
    ...
    override fun visitInlinedFunctionBlock(inlinedBlock: IrInlinedFunctionBlock): IrInlinedFunctionBlock =
        IrInlinedFunctionBlockImpl(
            ...
            statements.addAll(inlinedBlock.statements.memoryOptimizedMap { it.transform() })
    ...
    override fun visitConstantObject(expression: IrConstantObject): IrConstantObject =
        IrConstantObjectImpl(
            ...
            valueArguments.addAll(expression.valueArguments.memoryOptimizedMap { it.transform() })
            typeArguments.addAll(expression.typeArguments.memoryOptimizedMap { it.remapType() })
            processAttributes(expression)
        }
    ...
    override fun visitConstantArray(expression: IrConstantArray): IrConstantArray =
        IrConstantArrayImpl(
            ...
            elements.addAll(expression.elements.memoryOptimizedMap { it.transform() })
            processAttributes(expression)
        }
    ...
    override fun visitDynamicOperatorExpression(expression: IrDynamicOperatorExpression): IrDynamicOperatorExpression =
        IrDynamicOperatorExpressionImpl(
            ...
            arguments.addAll(expression.arguments.memoryOptimizedMap { it.transform() })
            processAttributes(expression)
        }
