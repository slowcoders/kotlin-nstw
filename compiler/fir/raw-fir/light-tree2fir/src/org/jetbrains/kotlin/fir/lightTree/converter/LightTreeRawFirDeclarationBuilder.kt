...
import org.jetbrains.kotlin.fir.analysis.functionCallHasLabel
...
class LightTreeRawFirDeclarationBuilder(
    ...
    private fun functionCallHasLabel(sourceElement: KtSourceElement): Boolean =
        functionCallHasLabel(sourceElement.lighterASTNode, { it.elementType }, { it.getChildren(sourceElement.treeStructure) })
