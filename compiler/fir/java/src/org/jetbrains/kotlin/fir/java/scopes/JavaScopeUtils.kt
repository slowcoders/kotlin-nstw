...
private fun FirCallableSymbol<*>.isFromBuiltinClass(session: FirSession): Boolean {
    ...
    return containingFile.hasAnnotation(StandardClassIds.Annotations.BuiltinWithoutBytecode, session)
            || containingFile.hasAnnotation(StandardClassIds.Annotations.BuiltinWithBytecode, session)
}
