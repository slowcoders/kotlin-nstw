...
import org.jetbrains.kotlin.fir.analysis.checkers.expression.FirOptInAnnotationCallChecker.representation
...
object FirOptInAnnotationCallChecker : FirAnnotationCallChecker(MppCheckerKind.Common) {
    override fun check(expression: FirAnnotationCall, context: CheckerContext, reporter: DiagnosticReporter) {
        ...
        if (isRequiresOptIn || isOptIn) {
            ...
            if (declaration != null) {
                val (isSubclassOptInApplicable, message) = isSubclassOptInApplicable(declaration)
    ...
    fun isSubclassOptInApplicable(firKlass: FirClass): Pair<Boolean, String?> {
